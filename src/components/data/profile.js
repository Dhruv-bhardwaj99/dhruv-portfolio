export const profile = {
  ...
  location: "Hoboken, NJ",
  title:
    "Software Engineer | MERN (React, Node.js, MongoDB) | MS CS @ Stevens",
  summary:
  ...
  highlights: [
    ...
    "Improved backend API performance and reliability via query optimization and refactoring.",
    "Strong foundations in databases, distributed systems, and secure web development.",
  ],
};